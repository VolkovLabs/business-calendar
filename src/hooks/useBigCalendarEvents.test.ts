...
import { useBigCalendarEvents } from './useBigCalendarEvents';

/**
 * Use Big Calendar Events
 */
describe('useBigCalendarEvents', () => {
  /**
  ...
  it('Should transform events to calendar events', () => {
    ...
    const { result } = renderHook(() => useBigCalendarEvents(events));
  ...
  it('Should cache results', () => {
    ...
    const { result, rerender } = renderHook(() => useBigCalendarEvents(events));
